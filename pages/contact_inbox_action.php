...
//		$query="UPDATE contact_form SET reply=?,status=?,replyDate=? WHERE contactID=?";
//		$stmt=$ConnectingDB->prepare($query);
//		$stmt->bind_param("sisi",$reply,$status,NOW(),$id);
//		$stmt->execute();
...
$mail->setFrom('moniruzzamanjoy05@gmail.com', 'Lifey');
$mail->addAddress($email);     // Add a recipient
//$mail->addAddress('ellen@example.com');               // Name is optional
$mail->addReplyTo('moniruzzamanjoy05@gmail.com', 'Lifey');
