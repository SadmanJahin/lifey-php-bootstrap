...
//			}else {
//				// Passed
//				$toEmail = 'joyultimates@gmail.com';
//				$subject = 'Contact Request From '.$name;
//				$body = '<h2>Contact Request</h2>
//					<h4>Name</h4><p>'.$name.'</p>
//					<h4>Email</h4><p>'.$email.'</p>
//                    <h4>Contact No.</h4><p>'.$contact_no.'</p>
            ...
            <div class="row">
                <div class="col-md-6">
                     <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <textarea class="form-control" name="message" rows="3" value="<?php echo isset($POST['message']) ? message : '';?>" required></textarea>
                            </div>
                        </div>
                        <div class="form-row">
